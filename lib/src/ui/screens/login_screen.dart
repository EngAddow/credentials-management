...
import 'package:flutter_app/src/blocs/signup/signup_bloc.dart';
...
import 'package:flutter_app/src/ui/screens/signup_screen.dart';
import 'package:flutter_app/src/ui/widgets/app_textfield.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Container(width: 150,color: Colors.grey,height: 1.5,margin: const EdgeInsets.only(right: 5),),
                  Text('or',style:Theme.of(context).textTheme.caption),
                Container(width: 150,color: Colors.grey,height: 1.5,margin: const EdgeInsets.only(left: 5),),
